...
module.exports.run = async (Client, message, args) => {
    ...
    const IMGClasses = new MessageAttachment("src/assets/bdo/civilization_classes.png")
    const IMGPlatforms = new MessageAttachment("src/assets/bdo/civilization_platforms.png")
    const IMGRegions = new MessageAttachment("src/assets/bdo/civilization_regions.png")

    let embedClasses0 = new MessageEmbed()
    ...
    let embedClasses1 = new MessageEmbed()
    ...
    let embedPlatforms = new MessageEmbed()
    ...
    let embedRegions = new MessageEmbed()
