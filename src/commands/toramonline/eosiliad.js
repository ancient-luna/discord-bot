...
module.exports.run = async (Client, message, args) => {
    ...
    message.guild.channels.cache.get('952164768217706496').send(`Please welcome our new departured legendary saviour, <@${target.user.id}>\nMay the lights guide us, within ${role} bond for the unseen journey`).then(target.roles.add(role));
