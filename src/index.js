  ...
  if (reaction.message.channel.id === '1049815440198733895') {
    if (reaction.emoji.name === 'xu_bdo_class_warrior') {
      ...
      const classText = new MessageEmbed()
        .setTitle(`${reaction.message.guild.members.cache.get(user.username)} Has Chosen Warrior`)
    ...
    if (reaction.emoji.name === 'xu_bdo_class_ranger') {
      ...
      const classText = new MessageEmbed()
        .setTitle(`${reaction.message.guild.members.cache.get(user.username)} Has Chosen Ranger`)
    ...
    if (reaction.emoji.name === 'xu_bdo_class_sorceress') {
      ...
      const classText = new MessageEmbed()
        .setTitle(`${reaction.message.guild.members.cache.get(user.username)} Has Chosen Sorceress`)
    ...
    if (reaction.emoji.name === 'xu_bdo_class_berserker') {
      ...
      const classText = new MessageEmbed()
        .setTitle(`${reaction.message.guild.members.cache.get(user.username)} Has Chosen Berserker`)
    ...
    if (reaction.emoji.name === 'xu_bdo_class_tamer') {
      ...
      const classText = new MessageEmbed()
        .setTitle(`${reaction.message.guild.members.cache.get(user.username)} Has Chosen Tamer`)
    ...
    if (reaction.emoji.name === 'xu_bdo_class_musa') {
      ...
      const classText = new MessageEmbed()
        .setTitle(`${reaction.message.guild.members.cache.get(user.username)} Has Chosen Musa`)
    ...
    if (reaction.emoji.name === 'xu_bdo_class_maehwa') {
      ...
      const classText = new MessageEmbed()
        .setTitle(`${reaction.message.guild.members.cache.get(user.username)} Has Chosen Maehwa`)
    ...
    if (reaction.emoji.name === 'xu_bdo_class_valkyrie') {
      ...
      const classText = new MessageEmbed()
        .setTitle(`${reaction.message.guild.members.cache.get(user.username)} Has Chosen Valkyrie`)
    ...
    if (reaction.emoji.name === 'xu_bdo_class_ninja') {
      ...
      const classText = new MessageEmbed()
        .setTitle(`${reaction.message.guild.members.cache.get(user.username)} Has Chosen Ninja`)
    ...
    if (reaction.emoji.name === 'xu_bdo_class_wizard') {
      ...
      const classText = new MessageEmbed()
        .setTitle(`${reaction.message.guild.members.cache.get(user.username)} Has Chosen Wizard`)
    ...
    if (reaction.emoji.name === 'xu_bdo_class_witch') {
      ...
      const classText = new MessageEmbed()
        .setTitle(`${reaction.message.guild.members.cache.get(user.username)} Has Chosen Witch`)
    ...
    if (reaction.emoji.name === 'xu_bdo_class_darkknight') {
      ...
      const classText = new MessageEmbed()
        .setTitle(`${reaction.message.guild.members.cache.get(user.username)} Has Chosen Dark Knight`)
    ...
    if (reaction.emoji.name === 'xu_bdo_class_striker') {
      ...
      const classText = new MessageEmbed()
        .setTitle(`${reaction.message.guild.members.cache.get(user.username)} Has Chosen Striker`)
    ...
    if (reaction.emoji.name === 'xu_bdo_class_mystic') {
      ...
      const classText = new MessageEmbed()
        .setTitle(`${reaction.message.guild.members.cache.get(user.username)} Has Chosen Mystic`)
    ...
    if (reaction.emoji.name === 'xu_bdo_class_archer') {
      ...
      const classText = new MessageEmbed()
        .setTitle(`${reaction.message.guild.members.cache.get(user.username)} Has Chosen Archer`)
    ...
    if (reaction.emoji.name === 'xu_bdo_class_lahn') {
      ...
      const classText = new MessageEmbed()
        .setTitle(`${reaction.message.guild.members.cache.get(user.username)} Has Chosen Lahn`)
    ...
    if (reaction.emoji.name === 'xu_bdo_class_shai') {
      ...
      const classText = new MessageEmbed()
        .setTitle(`${reaction.message.guild.members.cache.get(user.username)} Has Chosen Shai`)
    ...
    if (reaction.emoji.name === 'xu_bdo_class_guardian') {
      ...
      const classText = new MessageEmbed()
        .setTitle(`${reaction.message.guild.members.cache.get(user.username)} Has Chosen Guardian`)
    ...
    if (reaction.emoji.name === 'xu_bdo_class_hashashin') {
      ...
      const classText = new MessageEmbed()
        .setTitle(`${reaction.message.guild.members.cache.get(user.username)} Has Chosen Hashashin`)
    ...
    if (reaction.emoji.name === 'xu_bdo_class_nova') {
      ...
      const classText = new MessageEmbed()
        .setTitle(`${reaction.message.guild.members.cache.get(user.username)} Has Chosen Nova`)
    ...
    if (reaction.emoji.name === 'xu_bdo_class_sage') {
      ...
      const classText = new MessageEmbed()
        .setTitle(`${reaction.message.guild.members.cache.get(user.username)} Has Chosen Sage`)
    ...
    if (reaction.emoji.name === 'xu_bdo_class_corsair') {
      ...
      const classText = new MessageEmbed()
        .setTitle(`${reaction.message.guild.members.cache.get(user.username)} Has Chosen Corsair`)
    ...
    if (reaction.emoji.name === 'xu_bdo_class_drakania') {
      ...
      const classText = new MessageEmbed()
        .setTitle(`${reaction.message.guild.members.cache.get(user.username)} Has Chosen Drakania`)
