    ...
    interaction
        ...
        .then((modalInteraction) => {
            ...
            const embedForm = new EmbedBuilder()
                ...
                .setDescription(`-# Adventurer <@${interaction.user.id}> just applied. • [check ${famName} profile here](<https://blackdesert.pearlabyss.com/ASIA/en-us/Game/Profile/Search?_type=2&_keyword=${famName}>)`)
                .addFields(
